...
const ConvertFromJpgPage = () => {
  const [file, setFile] = useState(null);
  const [imageSrc, setImageSrc] = useState(null);
  const [error, setError] = useState("");
  const [filterSelected, setFilterSelected] = useState("png");

  const filters = ["png", "webp", "avif", "tiff", "gif", "raw"];
  ...
  const download = async () => {
    ...
    SendImageForConvertFromJpg(imageSrc, filterSelected, false, extension)
    .then(result => {
  ...
  const SendImageForConvertFromJpg = async (base64Image, format, isCompression, extension) => {
        ...
        <div className="flex-container">
          ...
          <PositionedComponent backgroundColor="transparent" positionContent="full">
            <WrapperComponent>
              ...
              >
                <div>
                  <TitleComponent text="Convert From Jpg Image" />
...
export default ConvertFromJpgPage;
